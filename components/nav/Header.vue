    ...
    <header class="header">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                ...
                <div class="collapse navbar-collapse header__links justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <nuxt-link class="nav-link" to="/about-abi" nuxt-link-active exact>About ABI</nuxt-link>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <nuxt-link class="nav-link btn" to="/login" nuxt-link-active>Login</nuxt-link>
                        </li>
                    </ul>
                </div>
            </div>
