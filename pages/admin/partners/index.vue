<template>
    <div class="wrapper">
        <div class="wrapper__head d-flex justify-content-between">
            <h1 class="wrapper__head--title">Partners</h1>
            <nuxt-link to="/admin/partners/create" class="btn wrapper__head--btn">Add Partner Logo</nuxt-link>
        </div>
                ...
                <div class="row">
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr class="wrapper__table--row" v-for="(doc, index) in docs" :key="doc.id">
                                        ...
                                        <td class="">
                                            <!-- <nuxt-link :to="{ name: 'admin-partners-id', params:{ id: doc._id} }" class="btn btn-primary">
                    ...
                    <div class="col-12" v-else>
                        <div class="wrapper__empty text-center">
                            ...
                            <h3 class="wrapper__empty--title">No Partner</h3>
                            <nuxt-link to="/admin/partners/create" class="btn wrapper__empty--btn">Add Partner</nuxt-link>
                        </div>
                    </div>
                </div>
...
<script>
    export default {
        ...
        head(){
            return{
                title: 'Partners -  Africa Blockchain Institute',
                meta: [
                    {
                        name: 'Partners',
                        content: 'Partners'
        ...
        methods:{
            async getDocs(){
                let docs = await this.$axios.$get(`/partners?page=${this.page}&limit=${this.perPage}`)
